...
[issue in this repo](https://github.com/threatcode/osv-schema/issues/new).
...
[here](https://github.com/threatcode/osv-schema/blob/main/validation/schema.json).
...
| Your database here | [Send us a PR](https://github.com/threatcode/osv-schema/compare). |
...
| Your quantitative severity type here. | [Send us a PR](https://github.com/threatcode/osv-schema/compare). |
...
| Your ecosystem here. | [Send us a PR](https://github.com/threatcode/osv-schema/compare). |
...
[conversion tool](https://github.com/threatcode/osv-schema/blob/79c4fbb1715a441985aad591acdd22c449d98960/tools/debian/convert_debian.py),
...
- 2022-03-24 Released version 1.3.0. Added `last_affected` event type and
  ...
  Context: https://github.com/threatcode/osv-schema/issues/35.
